...
def is_excluded_type(extension):
    exclude_list = [".jpg", ".jpeg", "png", "mp3", "mp4"]
...
def web_search_main(query_str):
    ...
    url_list, doc_url_map = get_url(cosine_query_doc, doc_url_map)
...
#string = query_str = "  e Builder registration tool is a web-based schedule "
#web_search_main(string)
